...
GType _gtk_file_system_module_get_type (void) G_GNUC_CONST;
  ...
  if (g_module_supported ())
    {
      ...
      module_path = hildon_fm_private_find_module (file_system_name, "filesystems");
      #else
      module_path = NULL;
      #endif
